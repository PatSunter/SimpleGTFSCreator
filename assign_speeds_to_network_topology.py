...
if __name__ == "__main__":
    mode = 'bus'
    input_segments_fname = "/Users/pds_phd/Dropbox/PhD-TechnicalProjectWork/OSSTIP_BZE/Melbourne_GIS_NetworkDataWork/BZE_New_Network/bus-node-edges-12_dec/bus-edges-copy.shp"

    mode_config = settings[mode]
    # Open in write-able mode, hence the 1 below.
    route_segments_shp = osgeo.ogr.Open(input_segments_fname, 1)    
